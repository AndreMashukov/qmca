...
describe('Service Tests', () => {
  describe('Calibration Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(CalibrationService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Calibration(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Calibration', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            regionFile: 'BBBBBB'
