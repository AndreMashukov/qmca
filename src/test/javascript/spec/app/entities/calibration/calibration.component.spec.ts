...
import { CalibrationComponent } from 'app/entities/calibration/calibration.component';
...
describe('Component Tests', () => {
  describe('Calibration Management Component', () => {
    let comp: CalibrationComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.calibrations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
